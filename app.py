...
EXAMPLE_PDF_URL = os.getenv("https://cdn.jsdelivr.net/gh/fablegros-ux/flashcard3@main/cartes_recto_verso-15.pdf", "https://cdn.jsdelivr.net/gh/fablegros-ux/flashcard3@main/cartes_recto_verso-15.pdf")
COLOR_MAP = {
...
def build_pdf(
    ...
    for i in range(NB_CARTES):
        ...
        style_recto_with_image = ParagraphStyle(
            "RectoImage", fontName=base_font, fontSize=10, leading=12,
            alignment=TA_CENTER, textColor=recto_text_color
        )
